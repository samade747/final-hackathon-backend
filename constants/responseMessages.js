export const responseMessages = {
  ...
  FATHER_EMAIL_EXISTS: "Father Email already exists 📧",
  PHONE_EXISTS: "Phone number already exists 📱",
  USER_EXISTS: "User already exists",
  TEACHER_HAVE_SLOT_IN_THIS_TIME: "Teacher have slot in this time",
  BATCH_AND_COURSE_EXISTS:
    "Batch already exists in this course or course already exists in this batch!",
  ...
  NO_TEACHER: "No Teahcer found",
  PASSWORD_LENGTH: "Password length should be greater than 6 🔒",
